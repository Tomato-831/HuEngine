...
void Player_L::Initialize()
{
	sprite_.params.pos.x = -980.0f - 64.0f;
...
//当たり判定
Math::Rectangle Player_L::GetCollision()
{
...
void Player_L::OnCollision()
{
	SetInitialPosition();
}
void Player_L::SetInitialPosition()
{
	sprite_.params.pos = Math::Vector2(
		(RenderingPath->GetLogicalWidth() * 3.0f - sprite_.params.siz.x) / 2.0f,
