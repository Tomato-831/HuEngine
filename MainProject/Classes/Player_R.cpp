...
void Player_R::Initialize()
{
	sprite_.params.pos.x = 1580.0f - 64.0f;
...
//当たり判定
Math::Rectangle Player_R::GetCollision()
{
...
void Player_R::OnCollision()
{
	SetInitialPosition();
}
void Player_R::SetInitialPosition()
{
	sprite_.params.pos = Math::Vector2(
		(RenderingPath->GetLogicalWidth() * -1.0f - sprite_.params.siz.x) / 2.0f,
